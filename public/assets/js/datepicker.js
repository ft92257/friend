...
(function($){
	...
	$.fn.datepicker = function(opts){
		...
		function keydownInt(e){
			if (!((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode == MOB.keyCode.DELETE || e.keyCode == MOB.keyCode.BACKSPACE))) { return false; }
		}
